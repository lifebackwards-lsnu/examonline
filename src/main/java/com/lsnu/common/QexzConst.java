...
public class QexzConst {
    ...
    public static final String UPLOAD_FILE_PATH = "E:/tools/MyEclipse-workspace/examonline/upload/";
    public static final String UPLOAD_FILE_IMAGE_PATH = "E:/tools/MyEclipse-workspace/upload/images/";
